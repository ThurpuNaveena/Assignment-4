...
y = 3x^2-2x+\frac{1}{3} &
\end{align}
For $\vec{x} = \myvec{\frac{1}{3}\\0}$ substitute in (2.0.1)
\begin{align}
\myvec{\frac{1}{3} & 0}^T \myvec{3 & 0\\0 & 0}\myvec{\frac{1}{3}\\0}+\myvec{-2 & -1}\myvec{\frac{1}{3}\\0}+\frac{1}{3} =0
\end{align}
Hence $\frac{1}{3}$ is a zero
