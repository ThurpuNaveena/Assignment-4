...
\end{align}
Discriminant is zero and the nature of roots of equation $3x^2 - 2x + \frac{1}{3} = 0$ only one root.
From the graph the quadratic equation will have intersect x-axis.
