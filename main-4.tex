...
\end{align}
Discriminant is zero and the nature of roots of equation $3x^2 - 2x + \frac{1}{3} = 0$ has two equal real roots.
\begin{align}
\vec{x} &= \frac{1}{3} , \frac{1}{3}
\end{align}
\numberwithin{figure}{section}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{diagram.png}
\caption{Roots of $3x^2 -2x + \frac{1}{3} = 0$ }
\label{Roots of $x^2 -2x+ 1/3=0$}
\end{figure}
\end{document}
